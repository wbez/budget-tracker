...
**TKTK: Describe budget-tracker here.**
...
```
cd budget-tracker
mkvirtualenv --no-site-packages budget-tracker
...
```
* * * * * ubuntu bash /home/ubuntu/apps/budget_tracker/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|budget-tracker|tweet|`location`||||
|budget-tracker|facebook|`location`||||
|budget-tracker|email|`location`||||
|budget-tracker|new-comment||||
|budget-tracker|open-share-discuss||||
|budget-tracker|close-share-discuss||||
|budget-tracker|summary-copied||||
|budget-tracker|featured-tweet-action|`action`||``tweet_url``|
|budget-tracker|featured-facebook-action|`action`||``post_url``|
